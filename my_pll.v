...
/* Module Version: 5.7 */
/* /opt/lscc/diamond/3.9_x64/ispfpga/bin/lin64/scuba -w -n my_pll -lang verilog -synth lse -arch xo2c00 -type pll -fin 12 -fclkop 400 -fclkop_tol 5.0 -fclkos 50 -fclkos_tol 1.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -fb_mode 1  */
...
module my_pll (CLKI, CLKOP, CLKOS)/* synthesis NGD_DRC_MASK=1 */;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS="49.500000" */
             /* synthesis FREQUENCY_PIN_CLKOP="396.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 49.500000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 396.000000
